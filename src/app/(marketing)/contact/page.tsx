  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F7F6', fontFamily: 'var(--font-noto, Inter, system-ui, sans-serif)' }}>
      ...
      <div style={{
        ...
        padding: '64px 24px 72px', textAlign: 'center', color: 'white',
      }}>
        <div style={{
        ...
        <h1 style={{
          ...
          lineHeight: 1.15, letterSpacing: '-0.03em', margin: '0 auto 16px', maxWidth: 600,
        }}>
      ...
      {/* ── FORM + SIDEBAR ── */}
      <div style={{
        maxWidth: 900, margin: '-32px auto 0', padding: '0 20px 80px',
        display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 270px',
        ...
        {status === 'success' ? (
          <div style={{
            ...
            padding: '56px 32px', textAlign: 'center', gridColumn: '1 / -1',
          }}>
          ...
          <form onSubmit={handleSubmit} style={{
            ...
            <h2 style={{ fontSize: 20, fontWeight: 700, color: '#1A1A1F', marginBottom: 6, marginTop: 0 }}>
              {t('문의 양식', 'Contact Form', lang)}
            </h2>
            <p style={{ fontSize: 12, color: '#8A8D94', marginBottom: 24, marginTop: 0 }}>
                  ...
                  return (
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 3 }}>
                        <span style={{ fontSize: 13, fontWeight: 700, color: selected ? '#085041' : '#1A1A1F' }}>
                          {t(plan.ko, plan.en, lang)}
                        </span>
                        {plan.price && (
                          <span style={{ fontSize: 13, fontWeight: 700, color: '#1D9E75' }}>
                            {plan.price}<span style={{ fontSize: 10, fontWeight: 400, color: '#8A8D94' }}>/mo</span>
                          </span>
                        )}
                      </div>
                      <div style={{ fontSize: 11, color: selected ? '#1D9E75' : '#8A8D94' }}>
          ...
          <div style={{
            ...
            {PLANS.filter(p => p.price).map(p => (
              <div key={p.value} style={{
                ...
                padding: '9px 0', borderBottom: '1px solid #F0F0F2',
              }}>
                <div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={item.title} style={{
                ...
                borderBottom: i < 2 ? '1px solid #F0F0F2' : 'none',
              }}>
      ...
      <div style={{
        ...
        © 2025 Nook Wallet · <Link href="/" style={{ color: '#1D9E75', textDecoration: 'none' }}>nook-wallet.com</Link>
      </div>

      {/* Mobile responsive */}
      <style>{`
        @media (max-width: 720px) {
          div[style*="gridTemplateColumns: minmax(0,1fr) 270px"] {
