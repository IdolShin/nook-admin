  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F7F6', fontFamily: 'var(--font-noto, Inter, system-ui, sans-serif)' }}>
      ...
      <div style={{
        ...
        padding: isMobile ? '44px 20px 56px' : '64px 24px 72px',
        ...
        <div style={{
          ...
          marginBottom: 16, border: '1px solid rgba(255,255,255,0.18)',
        }}>
          {'📬 '}{t('비즈니스 문의', 'Business Inquiry', lang)}
        </div>
        <h1 style={{
          fontSize: isMobile ? 26 : 'clamp(28px, 6vw, 46px)',
      ...
      {/* FORM + SIDEBAR */}
      <div style={{
        maxWidth: 900, margin: isMobile ? '-24px auto 0' : '-32px auto 0',
        ...
        {status === 'success' ? (
          <div style={{
            ...
            <h2 style={{ fontSize: 22, fontWeight: 700, color: '#085041', marginBottom: 10 }}>
              {t('문의가 접수되었습니다!', 'Inquiry received!', lang)}
            </h2>
            <p style={{ fontSize: 15, color: '#5C5F66', lineHeight: 1.6, maxWidth: 360, margin: '0 auto 24px' }}>
              {t('빠른 시간 안에 연락드리겠습니다. 감사합니다 🙏', "We'll be in touch shortly. Thank you! 🙏", lang)}
            </p>
            <Link href="/" style={{
              display: 'inline-flex', alignItems: 'center', gap: 6,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{
            ...
            borderRadius: 16, padding: '20px 18px', color: 'white',
          }}>
      ...
      {/* FOOTER */}
      <div style={{
        borderTop: '1px solid #E2EDE6', padding: '20px 24px',
